...
<%
 ...
 <form action="UploadFile" method="post" enctype="multipart/form-data">
  ...
  <div class="row">
  <div class="col-xs-6 col-md-4"><label>Nom de document : </label><input type="text" name="nomd" class="form-control" required></div>
  ...
  <input type="submit" value="Ajouter document" class="btn btn-primary btn-lg pull-left">
</form> 
