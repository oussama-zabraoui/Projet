...
<div class="panel panel-primary">
  <div class="panel-heading">
    <h3 class="panel-title"> Ajouter Responsable    </h3>
  </div>
 ...
 <form action="Rresponsable" method="post">
  <div class="container">
    <div class="row">
  <div class="col-xs-6 col-md-4"><label>Nom de Responsable : </label><input type="text" name="nomr"  class="form-control" required></div>
  <div class="col-xs-6 col-md-4"><label>Matricule de Responsable : </label><input type="number" name="matr"  class="form-control" required></div>
  ...
  <input type="submit" value="Ajouter responsable" class="btn btn-primary btn-lg pull-left">
</form> 
